...
// let n = -9999999999999999999999999999999 / "Test";
...
// let m = 9999999999999999999999999999999n;
...
// console.log(9999999999999999999999999999999 > Infinity);

// const t = "Hello";
// const p = "Hello";
// const l = `Hello`;

// const l = `Hello ${t} ${2 + 2} ${console.log("Let it be")}`;
...
// // const ivanName = "Ivan name";

// // const ivanName = null;
// // const ivanName = 0;
// // const ivanName = "";
// // const ivanName = "false";
// const ivanName = undefined;
...
// // const authorName = ivanName || defaultUserName || console.log("Test");
...
// // const authorName = ivanRole === adminRole && "Admin" ?? 'User';  // Error!
...
// let user3Role = 0b0111;

// // let isAdmin = userRole & adminRole;

// let isAdmin = userRole === adminRole;

// // console.log(isAdmin, isAdmin.toString(2));

// let isSameRole = userRole & user2Role;

// isSameRole = userRole & user3Role;

// // console.log(isSameRole === user3Role);

// // isSameRole = (userRole & user3Role) === user3Role;

// // let friendRole = userRole | user3Role;
// // console.log(friendRole, friendRole.toString(2));
...
// // const productName = "";
// const productDefault = "Item name";
...
// const updateProductName = userRole === "admin" ? newProductName : 2 + 2;

// const updateProductName =
//   userRole === "admin" ? newProductName : productName || productDefault;

// const updateProductName =
//   (userRole === "admin" && newProductName) || productDefault;

// const updateProductName =
//   userRole === "admin" ? newProductName() + 23 : productName || productDefault;

// const updateProductName =
//   userRole === "admin" ? console.log("isAdmin") : console.log("notAdmin");

// const updateProductName =
//   userRole === "admin"
//     ? console.log("isAdmin") || newProductName
//     : console.log("notAdmin") || productName;
...
// if (price < 100) {
//   console.log(
//     "Cachback system is available for product with price more than 100 hryvnas"
//   );
//   cashbackAmount = 0;
// } else {
//   if (cashBackLevel > 0) {
...
//   if (cashbackAmount > 0 && useCashback) {
...
// switch (buttonType) {
//   case console.log("Test") || primaryType:
//     console.log("primary button");
// }
...
// console.log(PRODUCT_AMOUNT - productCount, "товарів не мають знижку");
...
// if (car > 3) {
//   console.log("Потрібна нова машина");
// }
...
//   if (step === goal / 2) {
//     console.log("Зроблено половину тренування");
//   }
...
//       if (!hasEdu) {
//         console.log("Ви не підходите через відсутність освіти");
//       }
//     }

//     if (!hasExp) {
//       console.log("Ви не підходите через нестачу досвіду");
//     }
//   }

//   if (age < 18) {
//     console.log("Ви не підходите за віком");
//   }
// }
...
// function calcSpace(amount, unit = console.log("unit is not defined") || "px") {
//   return `${amount * 4}${unit}`;
// }

// function calcSpace(amount, unit = getDefaultUnit() || "px") {
//   return `${amount * 4}${unit}`;
// }

// // console.log(calcSpace(5));

// // console.log(calcSpace(5, null));
...
// arrow function (analog of lambda in othe programming languages
...
//       return this.passweord === password;
//     },
//   },
// });
...
// console.log(user.verify("948475"));
...
// // console.log(testUser.__proto__ === User.prototype);
...
// console.log("============", user.verify("123qwe342us"), "============");

// console.log("===============================");

// const verifyUser = user.verify;

// console.log(verifyUser("123qwe342us"));
...
// console.log(verifyUser.apply(user, ["123qwe342us"]));
